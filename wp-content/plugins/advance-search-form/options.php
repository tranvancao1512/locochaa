...
?>
	...
	<h2><?php echo __('Advance Search Form','cactusthemes');?></h2>
...
<table cellspacing="0" cellpadding="0">
	<tr>
		<td><label for="post-types"><?php echo __('Post Types to search:','cactusthemes');?></label></td>
		<td>
		<?php			
	...
	<tr>
		<td><label for="post-types"><?php echo __('Search in categories: <br/><i>If leave empty, all categories will be searched</i><br/>','cactusthemes'); ?></label></td>	
		<td>
...
<p>If you want to add addition list of words, please enter in textarea below. One word a line</p>
	...
	<tr>
		<td><label for="asf-custom-words"><?php echo __('Custom Words','cactusthemes');?></label></td>
