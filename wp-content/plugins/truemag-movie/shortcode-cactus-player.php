<?php
function tm_parse_cactus_player($atts, $content){
            ...
            if((strpos($url, 'wistia.com') !== false )|| (strpos($code, 'wistia.com') !== false ) ){
                ...
                <?php
                 ...
                 <div class="obj-youtube">
                    ...
                    <param name="movie" value="//www.youtube.com/v/<?php echo extractIDFromURL($url); ?><?php echo $youtube_start_time != '' ? '&start=' . $youtube_start_time : '';?><?php if($onoff_related_yt!= '0'){?>&rel=0<?php }if($auto_play=='1'){?>&autoplay=1<?php }if($onoff_info_yt=='1'){?>&showinfo=0<?php }if($remove_annotations!= '1'){?>&iv_load_policy=3<?php }if($onoff_html5_yt== '1'){?>&html5=1<?php }?>&wmode=transparent" ></param>
...
add_shortcode( 'cactus_player', 'tm_parse_cactus_player' );