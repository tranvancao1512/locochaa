...
class FW_Extension_Backups_Demo extends FW_Extension {
	...
	protected function _init() {
		...
		add_action( 'truemag_welcome_importdata_tab_content', array($this, '_display_page') );
		// -------------------
	...
	public function do_install(FW_Ext_Backups_Demo $demo) {
		...
		do_action( 'truemag_backup_before_install_demo', $demo, $collection, $id_prefix, $tmp_dir );
