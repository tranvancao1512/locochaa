...
class OP_Option_page extends cOP_Option{
	...
	public function getOption($selectedValue = null){
		...
		$html = '';
		ob_start();
		wp_dropdown_pages(array('selected'=>$selectedValue,'name'=>$this->name,'show_option_none'=> esc_html('Select','cactusthemes'), 'option_none_value'=> ''));
